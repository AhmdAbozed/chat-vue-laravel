...
async function submitForm(event: Event) {
    try {
        ...
        const endpoint = "http://127.0.0.1:8000/api/users/signup"
...
<template>
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 bg">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#" @submit="submitForm">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Already have an Account? <router-link to="/Login"
                                class="font-medium text-blue-600 hover:underline dark:text-blue-500">Login</router-link>
                        </p>
                    </form>
                </div>
            </div>

...
<template>
    <div class=" text-gray-400 px-2 py-1 rounded-lg absolute bottom-12 ml-2 bg-gray-950 bg-opacity-65 animate-fadeInOut"
        role="alert" v-if="notFoundAlert">
        <span class="block sm:inline">User not found</span>
    </div>
    <form class="flex p-2 bg-gray-900 " @submit="createNewChat">
        <input type="text" class="h-8 flex-grow bg-gray-700 border-2 border-gray-800 rounded-full min-w-0 pl-2"
            placeholder="Add User.." name="receiverName">
